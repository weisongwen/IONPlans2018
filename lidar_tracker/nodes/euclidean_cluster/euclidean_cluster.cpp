		...
		*out_cloud_ptr = *out_cloud_ptr + *(final_clusters[i]->GetCloud());
				...
				)
		{
			...
			**********************************************************************/
			...
			if( (dimension_z<13)&&(dimension_z>11.0) &&(distance_to_doubledecker_cluster<9.0)
			&&(dimension_y<3.5)&&(dimension_y>2.5))//&& (dimension_y<(2.5+1)) && (dimension_z<(4.5+1)))
			{
				 // if( (dimension_y<15.5)&&(dimension_z<15.85))
				{
					bounding_box.dimensions.z=8.8;
			        ...
			        double elevation_max_point=atan2(4.4,sqrt(cloud_cluster.max_point.point.x *cloud_cluster.max_point.point.x
			        ...
			        double elevation_min_point=atan2(4.4,sqrt(cloud_cluster.min_point.point.x *cloud_cluster.min_point.point.x
