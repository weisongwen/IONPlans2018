...
class cpt2ENUOdom_():
    def __init__(self):
        ...
        self.OdometryPub_ = rospy.Publisher('odom', Odometry, queue_size=10)  # customerized odometry from ENU
    ...
    def callcptBestPos(self,data):
        ...
        self.Odometry_.header.seq = self.Imu_.header.seq
        ...
        self.Odometry_.pose.pose.position.z = 0.0 #self.alt_
